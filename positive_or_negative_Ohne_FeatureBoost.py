...
data = pd.read_csv('dataset_negative_positive_audit_analytics.csv',low_memory=False)
...
clf.fit(X0_train)
# use this classifier to predict normal data and outliers
y_pred_test = clf.predict(X0_test)
y_pred_outliers = clf.predict(X_negative_1)

#print for confusion matrix and report
